...
- Load the **User Stories** Google Drive files from Inception (if available)
...
- **ALWAYS** include these mandatory artifacts in the design plan:
  - [ ] Generate Components file with component definitions and high-level responsibilities
  - [ ] Generate Component Methods file with method signatures (business rules detailed later in Functional Design)
  - [ ] Generate Services file with service definitions and orchestration patterns
  - [ ] Generate Component Dependency file with dependency relationships and communication patterns
...
- Create an **Application Design Plan** Google Drive file under Inception → Application Design
...
- Create a **Components** Google Drive file under Inception → Application Design with:
  - Component name and purpose
  - Component responsibilities
  - Component interfaces
- Create a **Component Methods** Google Drive file under Inception → Application Design with:
...
- Create a **Services** Google Drive file under Inception → Application Design with:
  - Service definitions
  - Service responsibilities
  - Service interactions and orchestration
- Create a **Component Dependency** Google Drive file under Inception → Application Design with:
  - Dependency matrix showing relationships
  - Communication patterns between components
  - Data flow diagrams
- Create an **Application Design** Google Drive file under Inception → Application Design that consolidates the multiple design docs created above in a single file.

### 11. Log Approval
- Log approval prompt with timestamp in the `audit` Google Drive file
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the application design artifacts in Google Drive under Inception → Application Design
...
- Log the user's approval response with timestamp in the `audit` Google Drive file
- Include the exact user response text
- Mark the approval status clearly

### 15. Update Progress
- Mark Application Design stage complete in the `aidlc-state` Google Drive file
