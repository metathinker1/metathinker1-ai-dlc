...
- **Check for AGENTS.md** in the project root — if present, load and use it as primary context for understanding the project's architecture, conventions, and development guidelines before performing deeper analysis
...
Create a **Business Overview** Google Drive file under Inception → Reverse Engineering:
...
Create an **Architecture** Google Drive file under Inception → Reverse Engineering:
...
Create a **Code Structure** Google Drive file under Inception → Reverse Engineering:
...
Create an **API Documentation** Google Drive file under Inception → Reverse Engineering:
...
Create a **Component Inventory** Google Drive file under Inception → Reverse Engineering:
...
Create a **Technology Stack** Google Drive file under Inception → Reverse Engineering:
...
Create a **Dependencies** Google Drive file under Inception → Reverse Engineering:
...
Create a **Code Quality Assessment** Google Drive file under Inception → Reverse Engineering:
...
Create a **Reverse Engineering Metadata** Google Drive file under Inception → Reverse Engineering:
...
Update the `aidlc-state` Google Drive file:

```markdown
## Reverse Engineering Status
- [x] Reverse Engineering - Completed on [timestamp]
- **Artifacts Location**: Google Drive → Inception → Reverse Engineering
```
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the reverse engineering artifacts in Google Drive under Inception → Reverse Engineering
...
- **MANDATORY**: Log user's response in audit with complete raw input
