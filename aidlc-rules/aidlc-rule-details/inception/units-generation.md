...
- [ ] Generate **Unit of Work** Google Drive file with unit definitions and responsibilities
- [ ] Generate **Unit of Work Dependency** Google Drive file with dependency matrix
- [ ] Generate **Unit of Work Story Map** Google Drive file mapping stories to units
- [ ] **Greenfield only**: Document code organization strategy in Unit of Work file (see code-generation.md for structure patterns)
...
- Create a **Unit of Work Plan** Google Drive file under Inception
...
- Ask: "**Unit of work plan complete. Review the plan in Google Drive under Inception → Unit of Work Plan. Ready to proceed to generation?**"
- DO NOT PROCEED until user confirms

## Step 10: Log Approval
- Log prompt and response in the `audit` Google Drive file with timestamp
- Use ISO 8601 timestamp format
- Include complete approval prompt text

## Step 11: Update Progress
- Mark Units Generation Part 1 (Planning) complete in the `aidlc-state` Google Drive file
...
- [ ] Read the complete plan from the **Unit of Work Plan** Google Drive file
...
- [ ] Update the `aidlc-state` Google Drive file current status
- [ ] Save all generated artifacts to Google drive
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the units generation artifacts in Google Drive under Inception → Application Design
...
- Mark Units Generation stage complete in the `aidlc-state` Google Drive file
- Update the "Current Status" section
...
- All unit artifacts generated as Google Drive files:
  - **Unit of Work** file with unit definitions
  - **Unit of Work Dependency** file with dependency matrix
  - **Unit of Work Story Map** file with story mappings
